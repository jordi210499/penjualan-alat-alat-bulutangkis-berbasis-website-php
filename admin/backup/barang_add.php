...
<table class="table-list" width="100%" style="margin-top:0px;">
	...
	<tr>
	  ...
	  <td width="85%"><input name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="5" readonly="readonly"/></td></tr>
	<tr>
	  <td><strong>Nama Barang </strong></td>
	  <td><strong>:</strong></td>
	  <td><input name="txtNama" value="<?php echo $dataNama; ?>" size="50" maxlength="50" /></td>
	</tr>
	...
	<tr><td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><input type="submit" name="btnSimpan" value=" SIMPAN DATA " style="cursor:pointeronclick="return confirm('ANDA YAKIN INGIN MENGHAPUS DATA KATEGORI INI ... ?";></td>
    </tr>
</table>
</form>
