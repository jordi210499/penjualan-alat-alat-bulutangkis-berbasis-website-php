...
if(isset($_GET['open'])) {
	switch ($_GET['open']){	
		...
		case 'Beranda'   :if(!file_exists ("info_beranda.php"))  die ("File info_beranda.php tidak ada, Anda dapat membuat file ini dari dreamweaver"); 
								include "info_beranda.php"; break;
	...
	if(!file_exists ("info_beranda.php")) die ("File tidak ada"); 
		include "barang.php"; 
}
?>